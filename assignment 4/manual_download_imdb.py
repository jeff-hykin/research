...
from common_tools import make_sure_containing_folder_exists, download

name_of_folder = "imdb_database"

folder_path = join(__file__, name_of_folder)
tar_path    = folder_path+".nosync.tar.gz"
if not exists(folder_path):
    # if the tar doesnt exist, download it
    if not exists(tar_path):
        print("Downloading the imdb_database")
        download("http://ai.stanford.edu/~amaas/data/sentiment/aclImdb_v1.tar.gz", tar_path)
