...
number_of_features_per_word = 32
...
model = Sequential()
model.add(Embedding(input_dim=max_features, output_dim=number_of_features_per_word, input_length=maxlen))
model.add(SimpleRNN(number_of_features_per_word))
