...
def tokenize():
    ...
    return x_train, y_train, x_val, y_val, maxlen, validation_samples, max_words, word_index


x_train, y_train, x_val, y_val, maxlen, validation_samples, max_words, word_index = tokenize()
